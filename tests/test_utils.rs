...
pub fn create_test_params(query: &str, limit: Option<u32>) -> omnisearch_mcp::common::types::BaseSearchParams {
...
pub fn validate_search_result(result: &omnisearch_mcp::common::types::SearchResult, expected_provider: &str) {
